...
public class CubeRoad : MonoBehaviour
{
    ...
    private void CreateCube(){
        ...
        MaterialsBuilderRoad materialsBuilderRoad = new MaterialsBuilderRoad();

        MeshRenderer meshRenderer = this.GetComponent<MeshRenderer>();
        meshRenderer.materials = materialsBuilderRoad.MaterialsListRoad().ToArray();

        Meshy = this.GetComponent<MeshCollider>();
        Meshy.sharedMesh = meshBuilder.CreateMesh();
        ...
        //meshRenderer.GetComponent<Renderer>().material = yourMaterial.ToArray();
    }
}
